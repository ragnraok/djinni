...
abstract class Generator(spec: Spec)
{
  ...
  def writeCppFileGeneric(folder: File, namespace: String, fileIdentStyle: IdentConverter, includePrefix: String)(name: String, origin: String, includes: Iterable[String], beforeNameSpace: Option[String] = None, f: IndentWriter => Unit) {
